...
aarch64-none-elf-ld -o image.elf  --entry el2_entry -Tdata 0x40000000 -Ttext 0x0 -Map image.map main.obj main_el0.obj main_el2.obj startup.obj startup_el0.obj startup_el2.obj
